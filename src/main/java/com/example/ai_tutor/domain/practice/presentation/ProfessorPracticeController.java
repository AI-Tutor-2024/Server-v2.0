...
import com.example.ai_tutor.domain.practice.dto.response.PracticeUpdateApiResponse;
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(    responseCode = "200",
                            description = "Practice 문제 생성 및 저장 성공",
                            content = @Content(schema = @Schema(implementation = ProfessorPracticeListRes.class)))
            })
    @PostMapping(value = "/{noteId}/generate-and-save")
    public Mono<ResponseEntity<com.example.ai_tutor.global.payload.ApiResponse<ProfessorPracticeListRes>>> generateAndSavePractice(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            content = @Content(mediaType = "application/json",
                                    schema = @Schema(implementation = PracticeUpdateApiResponse.class)
                            )),
